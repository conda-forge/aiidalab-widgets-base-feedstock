About aiidalab-widgets-base-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aiidalab-widgets-base-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aiidalab-widgets-base-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aiidalab-widgets-base
# for installing globally
pixi global install aiidalab-widgets-base
```
...
It is possible to list all of the versions of `aiidalab-widgets-base` available on your platform:
...
```
pixi search aiidalab-widgets-base --channel conda-forge
```
